...
public class B_MyStoreActivity extends AppCompatActivity {
    ...
    private static Long store_count ;
    ...
    /**
     *
     * @param this_con get the context for check if somthing is change
     */
...
//=========================================initializing==========================
    ...
    /**
     * A function that is responsible for refreshing the screen whenever
     * something in the data changes
     * @param this_con for update the listview
     */
